...
class ArbitroResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Resources\ArbitroResource\Pages\ListArbitros::route('/'),
            'create' => \App\Filament\Resources\ArbitroResource\Pages\CreateArbitro::route('/create'),
            'edit' => \App\Filament\Resources\ArbitroResource\Pages\EditArbitro::route('/{record}/edit'),
        ];
    }
}
