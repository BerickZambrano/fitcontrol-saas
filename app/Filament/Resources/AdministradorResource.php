...
class AdministradorResource extends Resource
{
    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ->role(['Administrador', 'super_admin'])
    ...
    {
        return [
            'index' => \App\Filament\Resources\AdministradorResource\Pages\ListAdministradores::route('/'),
            'create' => \App\Filament\Resources\AdministradorResource\Pages\CreateAdministrador::route('/create'),
            'edit' => \App\Filament\Resources\AdministradorResource\Pages\EditAdministrador::route('/{record}/edit'),
        ];
    }
}
